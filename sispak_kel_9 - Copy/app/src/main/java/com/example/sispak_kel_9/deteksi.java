...
import com.example.sispak_kel_9.ml.Sazaraxxx;
...
public class deteksi extends AppCompatActivity {
    ...
    public void classifyImage(Bitmap image) {
        try {
            Sazaraxxx model = Sazaraxxx.newInstance(getApplicationContext());
            ...
            Sazaraxxx.Outputs outputs = model.process(inputFeature0);
            ...
            String[] classes = {"bercak_daun_sirih", "busuk_pangkal_batang", "layu_bakteri"};
